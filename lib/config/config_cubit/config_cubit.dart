...
class ConfigCubit extends Cubit<ConfigState> {
  ConfigCubit() : super(const ConfigState(status: ConfigStatus.initial));
  ...
  void toggleTheme() {
    ...
    emit(state.copyWith(status: ConfigStatus.themeToggled));
    CacheHelper.set(
  ...
  void toggleLanguage() {
    ...
    emit(state.copyWith(status: ConfigStatus.languageToggled));
  }
}
