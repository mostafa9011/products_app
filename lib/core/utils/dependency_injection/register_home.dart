...
import '../../../features/home/domain/usecases/get_users_use_case.dart';
...
void registerHome() {
  ...
  getIt.registerLazySingleton(() => GetUsersUseCase(getIt<HomeRepository>()));

  // register home bloc
  getIt.registerFactory(() => HomeBloc(getIt<GetUsersUseCase>()));
}
